...
export default function Home() {
  ...
  return <main>
    ...
    <footer><a className="brand" href="#top"><img src="/logo.png" alt="Gabitor AI" className="brand-logo" /><span className="brand-name">GABITOR</span></a><p>© 2026 Gabitor AI</p><p>AI-powered creative tools</p><div className="footer-links"><a href="/terms">Terms of Service</a><a href="/privacy">Privacy Policy</a></div></footer>
